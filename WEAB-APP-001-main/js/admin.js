document.addEventListener('DOMContentLoaded', async () => {
    // Check admin authentication and GitHub token
    ...
    if (!githubStorage.isAuthenticated()) {
        showNotification('GitHub authentication required. Please set up GitHub token.', 'error');
        githubBtn.click(); // Open GitHub token modal
        return;
    }
    ...
    githubBtn.addEventListener('click', () => {
        ...
        console.log('GitHub modal:', githubModal); // Debug log
