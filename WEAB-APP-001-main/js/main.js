    ...
    try {
        ...
        songsList.innerHTML = `
            <div class="text-center py-6">
                ...
                <p class="text-red-500">Unable to load songs. GitHub authentication required.</p>
                <button id="setupGithubBtn" class="mt-4 px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors">
                    <i class="fab fa-github mr-2"></i>Setup GitHub Access
                </button>
            </div>
        `;

        // Add click handler for GitHub setup button
        document.getElementById('setupGithubBtn').addEventListener('click', () => {
            adminBtn.click(); // Open admin modal to set up GitHub
        });
        return;
    }
